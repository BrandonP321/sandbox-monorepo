...
describe("App", () => {
  ...
  it("loads /faq directly and through browser history with its trailing slash", async () => {
  ...
  it("does not submit an RSVP while rendering or navigating from FAQ", () => {
    const fetcher = vi.fn();
    ...
    render(<App />);
    fireEvent.click(
      screen.getByRole("link", { name: "Registry & Gifts page" })
    );
